...
st.markdown('''
    <div style='text-align: center;'>
        <p style='color: green; margin: 0;'>* Valor da SELIC atual: <span style='color: orange;'>13.75%</span> *</p>
        <p style='color: green; margin: 0;'>* Valor do CDI atual: <span style='color: orange;'>13.65%</span> *</p>
    </div>
